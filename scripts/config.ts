...
import { LEIPZIG_PACKAGE, MUENCHEN_PACKAGE, KOELN_PACKAGE, FRANKFURT_PACKAGE, STUTTGART_PACKAGE, DUESSELDORF_PACKAGE, DORTMUND_PACKAGE, ESSEN_PACKAGE, HANNOVER_PACKAGE, NUERNBERG_PACKAGE, DRESDEN_PACKAGE, DUISBURG_PACKAGE, BOCHUM_PACKAGE, WUPPERTAL_PACKAGE, BIELEFELD_PACKAGE, BONN_PACKAGE, MUENSTER_PACKAGE, KARLSRUHE_PACKAGE } from './city-packages';
