...
import { LEIPZIG_PACKAGE, MUENCHEN_PACKAGE, KOELN_PACKAGE, FRANKFURT_PACKAGE, STUTTGART_PACKAGE, DUESSELDORF_PACKAGE, DORTMUND_PACKAGE, ESSEN_PACKAGE } from './city-packages';
